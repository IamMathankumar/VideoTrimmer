...
class FramesAdapter(private val viewSize: Int, private val localUrl: String, private var itemTotalCounts: Int, private val context: Context, private val itemClickListener: ItemClickListener, private var singleLengthToGetBitmap: Long) : RecyclerView.Adapter<FramesAdapter.ViewHolder>() {
